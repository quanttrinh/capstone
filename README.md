...
| Command | Purpose |
| --- | --- |
| `pnpm web:dev` | Start the Next.js development server |
| `pnpm web:build` | Build the frontend |
| `pnpm web:lint` | Run Oxlint's Next.js and type-aware integrations |
| `pnpm web:format` | Format the frontend with Oxfmt |
| `pnpm web:format:check` | Check frontend formatting with Oxfmt |
